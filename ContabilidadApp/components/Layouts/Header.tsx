                ...
                <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            ...
                            <span className="hidden align-middle text-2xl  font-semibold  transition-all duration-300 ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light md:inline">Accounting</span>
                        </Link>
                        <button
                            type="button"
                    ...
                    <div className="flex items-center space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
                        ...
                        <div className="dropdown flex shrink-0">
                            <Dropdown
                                ...
                                button={<img className="h-9 w-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src="/assets/images/logo.svg" alt="logo" />}
                            >
                                <ul className="w-[230px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                                    <li>
                                        <div className="flex items-center px-4 py-4">
                                            <img className="h-10 w-10 rounded-md object-cover" src="/assets/images/logo.svg" alt="logo" />
                                            <div className="ltr:pl-4 rtl:pr-4">
                                                <h4 className="text-base">
                                                 {`${auth.user}`}
                                                    <span className={`rounded ${auth.permissions === 'admin' ? 'bg-danger-light' : 'bg-primary-light'} px-1 text-xs  ${auth.permissions === 'admin' ? 'text-danger' : 'text-primary'} ltr:ml-2 rtl:ml-2`}>{auth.permissions}</span>
                                                </h4>
                                            </div>
                                        </div>
                                    </li>
                                    <li className="border-t border-white-light dark:border-white-light/10">
                                        <Link href={API_URL + 'logout'} onClick={signOut} className="!py-3 text-danger">
